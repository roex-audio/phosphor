...
Download the latest release from the [Releases](https://github.com/daveronan/phosphor/releases) page.
...
See the [Getting Started Guide](docs/getting-started.md) for a walkthrough of Phosphor's features, tools, and keyboard shortcuts.

## Feedback and Community

Phosphor is currently in **beta**. Your feedback helps shape the product.
...
**David Ronan** -- [daveronan.com](https://www.daveronan.com)
